    ...
    <div class="modal-dialog">
       <div class="modal-content">
          ...
          <div class="modal-body mt-2">
                ...
                <input id="nomsede" type="text" class="form-control" name="NomSede" placeholder="Nombre de la sede" required>
                <br>
                ...
                <br>
                <input id="coorsede" type="text" class="form-control" name="coordinador" placeholder="Coordinador de la sede" required>

                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <!--<button (click)="crearSede()" type="submit" class="btn btn-primary">Crear</button>-->
                    <input (click)="crearSede()" type="submit" class="btn btn-primary" value=" Guardar Datos">
                 </div>
             </form>
          </div>
